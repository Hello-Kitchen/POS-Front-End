    ...
    return (
        <div className='w-full h-full'>
            {(priceLess > 0) || (!config.payement) ? (
                <div className={`w-full h-full ${orderFoods.length === 0 ? 'bg-kitchen-yellow/60 cursor-not-allowed' : 'bg-kitchen-yellow cursor-pointer'} flex justify-center items-center p-3 shadow-[inset_0_10px_50px_-20px_rgba(0,0,0,0.7)]`}>
