...
import { FooterMainButton } from '../../Components/LayoutFooter/LayoutFooter';
...
describe('Footer Component', () => {
    ...
    describe('FooterMainButton', () => {
        ...
        test('clicking Terminée calls handlePayement, resets state, and navigates', async () => {
            ...
            expect(setConfig).toHaveBeenCalled();
            expect(setOrders).toHaveBeenCalledWith({number: "42", channel: "Sur place", orderId: null, food: [], tmp: {}});
            expect(navigate).toHaveBeenCalledWith('/dashboard');
